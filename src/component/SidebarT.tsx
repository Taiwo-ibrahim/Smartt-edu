...
const links = [
    { href: "/teacher", label: "Dashboard", icon: GoHome },
    { href: "/Subjects", label: "Attendance & Reports", icon: PiBookOpenTextThin },
    { href: "/dashboard/Home", label: "Student Management ", icon: HiOutlineComputerDesktop },
    { href: "/dashboard/Home", label: "Curriculum & Assignments", icon: MdOutlineAssignment },
    { href: "/dashboard/Home", label: "CBT & Exams", icon: IoReaderOutline },
    { href: "/dashboard/Home", label: "Results & class performance", icon: IoMdNotificationsOutline },
    { href: "/dashboard/Home", label: "Dialogue Box", icon: CgProfile },
    { href: "/dashboard/Home", label: "Notifications", icon: IoSettingsOutline },
    { href: "/dashboard/Home", label: "settings", icon: IoSettingsOutline },
    { href: "/dashboard/Home", label: "My Profile", icon: IoSettingsOutline },
  ] as const;

  
export function SidebarT() {
  ...
  return (
    <aside className="flex h-full flex-col max-w-[350px] w-[25%] border mi-h-[1025px] min-w-[280px] bg-[#FFFFFF] border-t border-l border-[#E4E7EC] text-black gap-y-[35px]">
        ...
        <nav className="w-[100%] flex flex-col gap-[30px]">
            {links.map((link) => {
            ...
            return (
                ...
                key={link.label}
                href={link.href}
                className={`group pl-[30px] flex items-center gap-3 text-[14px]/[22px] w-full rounded-r-[8px] p-2
                    ${
                    isActive
                ...
                >
                <Icon className={`" text-[28px] group-hover:text-[#B44A05] w-[32px] h-[32px]" ${
