...
const links = [
    ...
    { href: "/dashboard/Home", label: "My Subjects", icon: PiBookOpenTextThin },
...
export function Sidebar() {
  ...
  return (
      ...
      <nav className=" flex flex-col gap-[30px] pr-4">
        {links.map((link) => {
      ...
      <div className="mt-[70px] flex flex-col ml-[35px] w-full max-w-[240px] rounded-[16px] border border-[#D0D5DD]">
        ...
        <div className="mt-[18px] hover:underline hover:underline-offset-4 flex bg-[#F9FAFB] border-t rounded-b-[16px] cursor-pointer text-[#F04438] items-center gap-2 border-t-[#D0D5DD] p-[11px] w-full">
            <AiOutlineLogout/>
            <p>Log Out</p>
        </div>
      </div>
