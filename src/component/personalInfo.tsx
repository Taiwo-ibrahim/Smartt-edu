  ...
  return (
    <div className='flex flex-col gap-[24px] w-full'>
      <div className="flex flex-col w-full max-w-[520px] mt-[80px] mx-auto gap-[8px]">
        ...
        <p className="font-[400] text-[16px]/[24px] text-[#344054]">Sign up and get started with Edusmart. Fill in your details and you’re all set to explore our features</p>
      </div>
