...
const DashboardHeader: React.FC = () => (
    <nav className="flex items-center justify-between w-full bg-white border-b border-l border-r border-[#E4E7EC] pt-[25px] pb-[25px] sm:p-5">
...
export default function TeacherDashboard() {
  return (
    ...
    //         <main className="flex-1 p- bg-red border mt-2 bg-[#ffffff]">
    //             {/* Welcome Section */}
    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col">
      <div className="flex flex-col">
        ...
        <main className="flex-1 p-4 bg-[#ffffff] border mt-2">
          {/* Welcome Section */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <h1 className="text-2xl font-semibold text-gray-900">
              <p className="flex">
                <span className="text-[14px]/[22px] font-medium text-[#101828] mt-[7px]">
                  Hi,
                </span>
                &nbsp;Mr Ogulu 👋
              </p>
              <p className="text-[#101828] text-[16px]/[24px] font-normal mt-1">
                Have a look at the key metrics for First Term
              </p>
            </h1>

            {/* Date Buttons + Grade Select */}
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            >
              <p className="text-sm text-gray-500 mt-1">
                The average of your total attendance for each subject you taught
                this term
              </p>
              <div className="mt-4 space-y-2">
                <ProgressBar
            ...
            <StatCard title="Total Students" value="40+" className="col-span-1">
              ...
              <div className="h-24 w-full bg-gradient-to-r from-green-300 to-green-600 rounded-lg flex items-end justify-around p-2">
                <div
                  className="w-1/4 bg-white/30 rounded-t-md"
                  style={{ height: "80%" }}
                ></div>
                <div
                  className="w-1/4 bg-white/30 rounded-t-md"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="space-y-6 max-h-[400px] overflow-y-auto pr-2">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="flex justify-between text-xs text-gray-500 mb-2 flex-wrap">
                    <span>Submission Date: 23/09/24, 10:00AM</span>
                  ...
                  <p className="text-gray-600 text-sm mb-3">
                    This assignment is grouped into 2 sections. The first
                    section is a sum of 6 objective questions, while the second
                    section is a sum of 3 theory questions. Answer all
                    questions.
                  </p>
                  <div className="flex items-center text-xs text-gray-500 mb-3">
                    <Image
